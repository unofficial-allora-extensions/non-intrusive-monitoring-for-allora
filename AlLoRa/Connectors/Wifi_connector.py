    ...
    def send_and_wait_response(self, packet: Packet):
        ...
        try:
            ...
            try:
                ...
                response_packet.rssi = responses.get("rssi")
                response_packet.snr = responses.get("snr")
                
                print("Wifi CONNECTOR RSSI", response_packet.rssi)
                print("Wifi CONNECTOR SNR", response_packet.snr)
