...
#This class provides the definition of the AlLoRa Packet, modified in this project to support the transmission of the so-called
#"Control commands"
...
class Packet:
    ...
    def __repr__(self):
        return "Packet(mesh_mode={}, source='{}', destination='{}', checksum={}, payload={}, check={}, command={}, control={}, mesh={}, sleep={}, hop={}, debug_hops={}, change_rf={}, id={})".format(
            self.mesh_mode, self.source, self.destination, self.checksum, self.payload, self.check, self.command,
            self.control, self.mesh, self.sleep, self.hop, self.debug_hops, self.change_rf, self.id)
    ...
    #Functions to establish and obtain the CONTROL BIT
